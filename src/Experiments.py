...
# investigating the effect scaling and pca combinations when given explained variance ratio as parameter
...
# investigating the effect scaling and pca combinations when given n components as parameter
